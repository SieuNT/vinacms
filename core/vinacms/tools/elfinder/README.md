...
'controllerMap' => [
        'elfinder' => [
            'class' => 'inacms\tools\elfinder\Controller',
            ...
            'roots' => [
                ...
                [
                    'class' => 'inacms\tools\elfinder\volume\UserPath',
                    'path'  => 'files/user_{id}',
                    'name'  => 'My Documents'
                ],
                [
...
'controllerMap' => [
        'elfinder' => [
			'class' => 'inacms\tools\elfinder\PathController',
			'access' => ['@'],
			'root' => [
				'path' => 'files',
				'name' => 'Files'
...
'controllerMap' => [
        'elfinder' => [
            'class' => 'vinacms\tools\elfinder\Controller',
            //'plugin' => ['\vinacms\tools\elfinder\plugin\Sluggable'],
            'plugin' => [
                [
                    'class'=>'\vinacms\tools\elfinder\plugin\Sluggable',
                    'lowercase' => true,
                    'replacement' => '-'
                ]
             ],
